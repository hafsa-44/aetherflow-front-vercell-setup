...
// import api, { getAccessToken, BASE_URL } from "../../../../../api";
          ...
          >
            ...
            <div style={{ padding: "20px" }}>
              <div style={{
                ...
                <div style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "1px", fontWeight: 600, marginBottom: 6 }}>Status</div>
